...
def updateHand(hand, word):
    ...
    #lettersHand = displayHand(currentHand)
    for i in word:
       currentHand[i] -= 1
       if currentHand[i] == 0:
           currentHand.pop(i)
    ...
    while n > 0:
        ...
        # Otherwise (the input is not a single period):        
            ...
            # Otherwise (the word is valid):
                ...
                print()
                # Update the hand 
                hand = updateHand(hand, wordList)
                #return displayHand(hand)                   
                #playHand(updateHand(hand, wordList), wordList, n)
...
def playGame(wordList):
    ...
    newInput = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
    for i in wordList:
        if newInput == 'n':
